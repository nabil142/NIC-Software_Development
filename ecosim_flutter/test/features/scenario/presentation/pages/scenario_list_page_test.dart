...
import 'package:ecosim_flutter/features/scenario/presentation/pages/scenario_list_page.dart';
...
void main() {
  testWidgets('ScenarioListPage renders correctly', (WidgetTester tester) async {
