...
class _RadarChartPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final labelPositions = [
      Offset(center.dx, center.dy - maxRadius - 12),
      Offset(center.dx + maxRadius + 4, center.dy),
    ...
    for (int i = 0; i < 4; i++) {
      ...
      if (i == 0) {
        adjustedOffset = Offset(
          adjustedOffset.dx - textPainter.width / 2,
          adjustedOffset.dy,
        );
      } else if (i == 1) {
        adjustedOffset = Offset(
          adjustedOffset.dx,
          adjustedOffset.dy - textPainter.height / 2,
        );
      } else if (i == 2) {
        adjustedOffset = Offset(
          adjustedOffset.dx - textPainter.width / 2,
        ...
        adjustedOffset = Offset(
          adjustedOffset.dx - textPainter.width,
          adjustedOffset.dy - textPainter.height / 2,
        );
      }
