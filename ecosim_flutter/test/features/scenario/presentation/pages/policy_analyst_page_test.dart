...
import 'package:ecosim_flutter/features/scenario/presentation/pages/policy_analyst_page.dart';
...
void main() {
  testWidgets('PolicyAnalystPage renders correctly', (WidgetTester tester) async {
