...
import 'package:ecosim_flutter/features/scenario/presentation/pages/blueprint_page.dart';
...
void main() {
  testWidgets('BlueprintPage renders correctly', (WidgetTester tester) async {
